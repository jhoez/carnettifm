...
<h1 class="text-center">Jefe de Familia</h1>
...
<table class="table table-bordered">
    ...
    <tbody>
        <tr>
			...
			<td><?=$persona->getEdad() == -1 ? 0: $persona->getEdad();?></td>
...
<h1 class="text-center">Datos Hijos/as</h3>

<div class="">
	<?=GridView::widget([
		'dataProvider'=>$dataProviderh,
		'filterModel'=>$searchModelh,
		...
		'columns'=>[
				...
				'buttons'=>[
					'editar'=>function($id,$model,$url){
						return Html::a(
							...
							['persona/editarfamiliar','id'=>$model->id]
						);
					},
				],
			],
            [
				...
				'value'=>function($data){
					return $data->getparentfami()->getfamparentesco()['nombparent'];
				}
			],
            [
				'label'=>'Nacionalidad',
				...
				'value'=>function($data){
					return $data->nacionalidad == 'V' ? 'Venezolano' : 'Extranjero';
				}
			],
            [
                'label'=>'Categoria',
            ...
            [
                ...
                'value'=>function($model){
                    return $model->getEdad() == -1 ? 0 : $model->getEdad();
                }
            ],
			[
				'label'=>'Estado Civil',
...
<h1 class="text-center">Grupo Familiar</h3>
