...
{
    // ejecutar el comando php yii rbac/permisosrutas
    public function actionPermisosrutas()
    {
        ...
        $pathsuperadmincarnet = $auth->createPermission('/carnet/*');
        $auth->add($pathsuperadmincarnet);
        ...
        // RUTAS PARA PERSONAL
        $pathcarnetindex = $auth->createPermission('/carnet/index');
        $auth->add($pathcarnetindex);
        $pathcarnetcreate = $auth->createPermission('/carnet/create');
        $auth->add($pathcarnetcreate);
        $pathcarnetupdate = $auth->createPermission('/carnet/update');
        $auth->add($pathcarnetupdate);
        $pathcarnetview = $auth->createPermission('/carnet/view');
        $auth->add($pathcarnetview);
        ...
        $auth->addChild($permisosuperadmin,$pathsuperadmincarnet);
        ...
        $auth->addChild($permisoadministrador,$pathcarnetindex);
        $auth->addChild($permisoadministrador,$pathcarnetcreate);
        $auth->addChild($permisoadministrador,$pathcarnetview);
        $auth->addChild($permisoadministrador,$pathcarnetupdate);
        $auth->addChild($permisoadministrador,$pathsiteindex);
        $auth->addChild($permisoadministrador,$pathsitelogout);
        ...
        // ROLE 'administrador' y le asigna el permiso "permisoPersonal"
    ...
    */
    ...
    {
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Auditoria Interna')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Bienes Nacionales')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Compras')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Consultoria Juridica')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Contabilidad')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Corporación de Turismo Insular Miranda')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Dirección General de Despacho')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Dirección de Administración')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Dirección de Gestion Comunicacional')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Dirección de Presupuesto')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Dirección de Protección Civil y Administración de Desastres')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Dirección de Talento Humano')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Dirección de Tecnologia e Informatica')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Fundación de Alimentos Insular Miranda')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Fundación de Investigaciones Maritimas Insular Miranda')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Secretaria de Apoyo y Servicios Publicos')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Secretaria de Cultura')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Secretaria de Infraestructura y Proyectos')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Secretaria de Prevención y Seguridad Ciudadana')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Secretaria de Protección Social')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Secretaria de Salud')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Servicio Aeroportuario Insular Miranda')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Servicio de Administración Tributaria Insular Miranda')");
        $command->execute();
        $command = Yii::$app->db->createCommand("insert into carnet.departamento (nombdepart) values('Tesoreria')");
        $command->execute();
    }
    ...
    public function actionInsertarpersonal()
    {
        $command = Yii::$app->db->createCommand("
            insert into carnet.personal (ci,nombcompleto,sexo,fkimag,fkdepart)
            values
            -- Auditoria Interna
    ...
    public function actionCrearusuario()
    {
        ...
        $usuario->generatePasswordResetToken();
        $usuario->email = 'administrador@tifm.com';
        $usuario->status = 1;
        $usuario->created_at = date( "Y-m-d h:i:s",time() );
        $usuario->generateEmailVerificationToken();
        if ($usuario->save()) {
    ...
    */
    public function actionReiniciartablas()
    {
        ...
        $command->execute();
        $command = Yii::$app->db->createCommand('TRUNCATE TABLE carnet.departamento RESTART IDENTITY CASCADE');
        $command->execute();
        $command = Yii::$app->db->createCommand('TRUNCATE TABLE carnet.personal RESTART IDENTITY CASCADE');
        $command->execute();
        $command = Yii::$app->db->createCommand('TRUNCATE TABLE carnet.imagen RESTART IDENTITY CASCADE');
        $command->execute();
        $command = Yii::$app->db->createCommand('TRUNCATE TABLE carnet.usuario RESTART IDENTITY CASCADE');
        $command->execute();
    }
